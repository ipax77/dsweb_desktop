...
{
    public static class GameService2
    {
        public static async Task<ConcurrentDictionary<int, AddUnit>> GenFight(GameHistory _game, bool shuffle = true)
        {
            ...
            if (shuffle == true)
            {
                ...
                _game.battlefield.Units.AddRange(GameService2.ShuffleUnits(_game.Players));
            }
...
";
        ...
        public static List<Unit> ShuffleUnits(List<Player> players)
        {
            ...
            {
                pl.LastSpawn = new BBuild();
                pl.LastSpawn.GetBuild(pl);
