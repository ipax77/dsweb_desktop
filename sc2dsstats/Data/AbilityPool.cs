...
namespace paxgame3.Client.Data
{
    public class AbilityPool
    {
        ...
        public static void Build()
        {
            ...
            p.Regeneration = 2;
            p.Cooldown = new TimeSpan(0, 0, 10) / StartUp.Battlefieldmodifier;
            p.isActive = false;
            p.Tier = 0;
            ...
            PsionicTransfer.Duration = new TimeSpan(0, 0, 0, 7, 0) / StartUp.Battlefieldmodifier;
            ...
            LifeTime.Tier = 0;
            LifeTime.Cost = 0;
            LifeTime.Duration = new TimeSpan(0, 0, 0, 43) / StartUp.Battlefieldmodifier;
            ...
            TransfusionRegeneration.Regeneration = 50 / ((float)TransfusionRegeneration.Duration.TotalSeconds * StartUp.Battlefieldmodifier);
