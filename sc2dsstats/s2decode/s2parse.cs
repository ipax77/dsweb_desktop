...
namespace s2decode
{
    public static class s2parse
    {
        ...
        public static JsonWriterOptions jOptions = new JsonWriterOptions
        {
            Indented = true
        };
        ...
        public static void GetInit(string replay_file, dynamic init_dec)
        {
            ...
            //var json = JsonSerializer.Serialize(init_dec, jOptions);
            //File.WriteAllText(Program.workdir + "/bab/analyzes/" + id + "_init.json", json);
        ...
        public static void GetTrackerevents(string replay_file, dynamic trackerevents_dec)
        {
            ...
            Console.WriteLine("Serialize trackerevents ...");
            ...
            foreach (PythonDictionary pydic in trackerevents_dec)
            {
                ...
                //var json = System.Text.Json.Serialization.JsonSerializer.ToString<PythonDictionary>(pydic);
                var json = JsonSerializer.Serialize(pydic);
                File.AppendAllText(Program.workdir + "/bab/analyzes/" + id + "_tracker.json", json);
            }
            ...
            Console.WriteLine("Serialize trackerevents finished.");
        }
    }
}
